        ...
        <form action="<?= esc_url(admin_url('admin-post.php')); ?>" method="POST" class="form">
            <fieldset class="form__fields">
                <div class="field">
                    ...
                    <input type="text" name="lastname" id="lastname" class="field__input" placeholder="Votre nom">
                ...
                <div class="field">
                    ...
                    <input type="email" name="email" id="email" class="field__input" placeholder="Votre adresse mail">
                ...
                <div class="field">
                    ...
                    <input type="tel" name="phone" id="phone" class="field__input" placeholder="Votre numéro de téléphone">
                ...
                <div class="field">
                    ...
                    <input type="text" name="subject" id="subject" class="field__input" placeholder="Votre sujet">
                ...
                <div class="field">
                    ...
                    <textarea name="message" id="message" class="field__input" placeholder="Votre texte"></textarea>
